...
void SaveFonction2D(Data & d,Mesh & Mh,TabConnecInv & tab,ParamPhysic & Param,float t,Vertex c,int var);

void SaveFonction2DEuler(Data & d,Mesh & Mh,TabConnecInv & tab,ParamPhysic & Param,float t,Vertex c,int var);

void SaveFonction1D(Data & d,Mesh & Mh,TabConnecInv & tab,ParamPhysic & Param,float t,Vertex c,int var);
