...
\begin{equation*}
\|\V_h^{\eps}-\W^\eps_h\|_{L^2([0,T]\times\mathbb R)} \leq  \eps e^{T/2} \bigg(  C_0h + \sqrt{ \frac{1}{\sigma C_{\mathcal{M}} } \big( \frac12 + \frac{1}{\sigma^2} \big) } \|p_0\|_{H^2(\mathbb{R})} \bigg) ,
\end{equation*}
...
\textcolor{red}{\| p^\epsilon-p\|_{   L^\infty([0,T];H^n(\Omega))  }+
\| \mathbf{v} 
