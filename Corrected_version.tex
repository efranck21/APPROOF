...
Since $\| u^\eps  \|^2_{ L^2( [0,t] : H^1(\mathbb R) }\leq t \| \V^{\eps}(0) \|_{H^1(\mathbb{R})}^2$ and also 
$
\frac{\sigma}
{\eps^2}\| u^\eps  \|^2_{ L^2( [0,t] : H^1(\mathbb R) }\leq  \| \V^{\eps}(0) \|_{H^1(\mathbb{R})}^2$
...
\bibitem{TAHO} D. Aregba, M. Briani, R. Natalini, Time Asymptotic High Order Schemes for Dissipative BGK Hyperbolic Systems, arXiv:1207.6279.
